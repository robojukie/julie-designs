...
export const metadata: Metadata = {
  title: "Who am I?",
  description:
    "Product designer and problem solver, positively shaping the human experience",
};
          ...
          <div className="container-680">
            <div className="main-text">
              <p>
                As a designer, I&apos;m{" "}
                <strong>
                  excited about transforming legacy industries though technology
                  and designing ethical and inclusive products that leverage AI
                </strong>
                &rsquo;s potential.
              </p>
            </div>
            <div className="container-680">
              ...
              <div className="main-text">
                <p>
                  ...
                  When getting started, I build a strong understanding of the
                  user, industry, and stakeholders
                </p>
                <p>
                  <strong>
                    Communicate
                  ...
                  I engage early and often with users, engineers, and
                  stakeholders to make sure my work is aligned with product,
                ...
                <p>
                  ...
                  I readily adapt to changing priorities and deadlines,
                  iterating based on insights from data and user feedback
                </p>
              </div>
            </div>
          </div>
          <div className="container-680">
            ...
            <div className="main-text">
              <p>
                ...
                understand their struggles? It&apos;s something I want to
                actively practice, because it{" "}
          ...
          <div className="container-680">
            ...
            <div className="main-text">
              <p>
                ...
                education, healthcare. I&apos;m also interested fitness,
          ...
          <div id="hobbies" className="container-680">
            ...
            <div className="main-text">
              <p>
                ...
                climbing fake rocks 🧗, skiing ⛷, listening to podcasts 🎧,
                reading 📖, drawing 🖌️, at a comedy show 🎭, and seeking out new
                places ✈️ and activities 💃. (Can you tell I have many hobbies?)
              </p>
              <p>
                <a href="mailto:juliespaik@gmail.com" className="inline-link">
                  Say hello
                </a>
                ! I enjoy meeting people and would love to get to know you and
                share our experiences. Let&apos;s chat about design, something
                new you&rsquo;ve learned, or any one of my many hobbies (and
                potential future hobbies :D)!
              </p>
            </div>
          </div>
          <div className="container-680">
            <div className="section-heading-wrapper">
              <h2 className="main-section-header">
                My favorite podcasts to learn from
              </h2>
            </div>
